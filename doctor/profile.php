			...
			<div class="pl-lg-4">
                <div class="row">
					...
					<input type="hidden" value="<?php echo $row['photo'];?>" name="delete_img">
						<?php echo "<img src='http://localhost/appointment/admin/upload/".$row["photo"]."' width='150px' height='150px'>"?>
...
if(isset($_REQUEST["edit"]))
{
	...
	$qry2="update doctor set name='$v1',mobile='$v2',email='$v3',password='$v4', gender='$v5', dob='$v6', category='$v7',experince='$v8',city='$v9', hospitaladress='$v10',medicalid='$v11',fees='$v12',qualification='$v13' where id=".$_SESSION['id'];
...
if(isset($_REQUEST["update"])){
		...
		{
			move_uploaded_file($_FILES["file"]["tmp_name"],"../admin/upload/$v2");
		}
	if($qry1){
